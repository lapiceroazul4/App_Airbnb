        ...
        <div class="container">
            ...
            <nav class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="navbar-item"><a class="nav-link active" href="mostrarAirbnbsCliente.php" aria-current="page">Mostrar Airbnbs</a></li>
      ...
      <div class="col-md-12">
        <table class="table table-striped">
          ...
          <tbody id="airbnbsTableBody">
            <?php
            $jsonData = file_get_contents('http://localhost:3002/airbnbs');
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    hostIdInput.addEventListener('keyup', function() {
      applyFilter();
    });
    ...
    function applyFilter() {
      ...
      const hostIdFilterApplied = hostIdInput.value !== '';
      ...
      if (idFilterApplied || hostIdFilterApplied || roomTypeFilterApplied) {
    ...
    function filterTable() {
      ...
      rows.forEach(row => {
        ...
        const hostIdCell = row.cells[3].textContent;
        const roomTypeCell = row.cells[6].textContent;

        if ((id === '' || idCell.includes(id)) &&
            (hostId === '' || hostIdCell.includes(hostId)) &&
