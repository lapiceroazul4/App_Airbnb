<?php
    ...
    $api_url = "http://localhost:3003/reservas/hostID/$user_id";
    $api_response = file_get_contents($api_url);
    $reservas = json_decode($api_response, true);

    $airbnbs_response = file_get_contents('http://localhost:3002/airbnbs/hostId/' . $user_id);
    $airbnbs_data = json_decode($airbnbs_response, true);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="./php/procesarEliminarReservasHost.php" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="crearReservaForm" action="./php/procesarCrearReservasHost.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="airbnbId" name="airbnb_id" required>
                            <?php
                            foreach ($airbnbs_data as $item) {
