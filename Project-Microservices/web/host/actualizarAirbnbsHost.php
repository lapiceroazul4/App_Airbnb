<?php
    ...
    $response = file_get_contents('http://localhost:3002/airbnbs/hostId/' . $user_id);
...
<body>
        ...
        <div class="container">
            ...
            <nav class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="actualizarAirbnbsHost.php" aria-current="page">Actualizar Airbnbs</a></li>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="./php/procesarActualizarHost.php">
                    <div class="mb-3">
                        <label for="updateId" class="form-label">ID</label>
                        <select class="form-control" id="updateId" name="id" required>
                            <?php
