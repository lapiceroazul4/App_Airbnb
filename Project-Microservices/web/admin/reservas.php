<?php
    ...
    $api_url = "http://localhost:3003/reservas";
        ...
        <div class="container">
            ...
            <nav class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="reservas.php" aria-current="page">Reservar Airbnbs</a></li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php echo $name; ?>
                        </a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="./php/procesarEliminarReservas.php" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="crearReservaForm" action="./php/procesarCrearReservas.php" method="post">
                    <div class="mb-3">
