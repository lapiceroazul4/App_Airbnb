...
if ($response === false) {
    header("Location:../reservas.php?origin=post&error=true&id=$id");
} else {
    header("Location:../reservas.php?origin=post&success=true&id=$id&airbnb_name=$airbnb_name&airbnb_id=$airbnb_id&client_name=$client_name");
}
?>