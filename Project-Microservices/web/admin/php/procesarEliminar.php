...
$airbnbs_get="http://localhost:3002/airbnbs/id/$id";
$curl_get=curl_init();
...
$airbnbs_delete = "http://localhost:3002/airbnbs/$id";
...
if ($response_delete === false) {
    header("Location:../eliminarAirbnbs.php?error=true?id=$id");
} else {
    header("Location:../eliminarAirbnbs.php?success=true&id=$id&hostID=$hostID&hostName=$hostName");
}
?>