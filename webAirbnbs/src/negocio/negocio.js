async function getAirbnbs(req, res) {
  try {
    const response = await fetch("http://localhost:3002/airbnbs");
...
async function getAirbnbsByID(req, res) {
  ...
  try {
    const response = await fetch(`http://localhost:3002/airbnbs/id/${id}`);
    const data = await response.json();
...
async function getAirbnbsByHostId(req, res) {
  ...
  try {
    const response = await fetch(
      `http://localhost:3002/airbnbs/hostId/${hostId}`
    );
    const data = await response.json();
...
async function getAirbnbsByRoomType(req, res) {
  ...
  try {
    const response = await fetch(
      `http://localhost:3002/airbnbs/roomType/${roomType}`
    );
    const data = await response.json();
...
async function updateAirbnb(req, res) {
  ...
  try {
    const response = await fetch(`http://localhost:3002/airbnbs/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
...
async function userValidation(req, res) {
  try {
    const response = await fetch("http://localhost:3001/user/validation", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
async function getReservas(req, res) {
  try {
    const response = await fetch("http://localhost:3003/reservas");
    const data = await response.json();
    res.json(data);
  } catch (error) {
    console.error("Error:", error);
...
async function getReservasByUserID(req, res) {
  ...
  try {
    const response = await fetch(`http://localhost:3003/reservas/userID/${user_id}`);
    const data = await response.json();
...
async function deleteReservaByID(req, res) {
  ...
  try {
    const response = await fetch(`http://localhost:3003/reservas/id/${id}`, {
      method: "DELETE",
    });
