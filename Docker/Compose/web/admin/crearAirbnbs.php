...
<body>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-12">
                <form id="createForm" action="./php/procesarCrear.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="updateIdHost" class="form-label">ID Host</label>
                        <input type="text" class="form-control" id="updateIdHost" name="idHost" required>
                    </div>
                    <div class="mb-3">
                        <label for="updateHostName" class="form-label">Nombre de Host</label>
                        <input type="text" class="form-control" id="updateHostName" name="nameHost" required>
                    </div>
                    <div class="mb-3">
